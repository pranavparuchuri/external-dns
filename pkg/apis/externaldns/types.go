...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("node-filter", "Filter nodes used for nodeports managed by external-dns via label selector when listing all resources; currently supported by source type service").Default(defaultConfig.NodeFilter).StringVar(&cfg.NodeFilter)
